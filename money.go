...
// MulInt 乘法运算，浮点数和 int64 类型的值相乘
func MulInt(a float64, b int64) float64 {
	return Mul(a, float64(b))
}

// Mul 乘法运算，浮点数和浮点数相乘
func Mul(a, b float64) float64 {
	des, _ := decimal.NewFromFloat(a).Mul(decimal.NewFromFloat(b)).Float64()
	return des
}
